            ...
            if (state is ActivitiesSuccess) {
              return ListView.separated(
                ...
                itemBuilder: (context, index) => TextButton(
                  onPressed: () {
                    selectModelsCubit.setSelectedActivity(
                      state.activities[index],
                    );
                    // workoutCubit.programId =
                    //     state.activities[index].programId.toString();
                    GoRouter.of(context).pop();
                  },
                  child: Text(
                    capitalize(state.activities[index].name!),
